...
class Docking:
    ...
    def _run_vina(self, df_boltz):
        ...
        df_boltz['merged_residues'] = df_boltz['vina_residues'].where(
            df_boltz['vina_residues'].astype(bool),
            df_boltz['Squidly_CR_Position']
        )
        ...
        df_vina = df_boltz << (Vina('Entry', 'structure', 'Sequence', 'substrate_smiles', 'substrate_name', 'merged_residues', vina_dir, self.num_threads))
        ...
        if df_vina['vina_dir'].isnull().any() == True: 
            ...
            df_missing_docked = df_missing << (Vina('Entry', 'structure', 'Sequence', 'substrate_smiles', 'substrate_name', 'merged_residues', vina_dir, self.num_threads))
