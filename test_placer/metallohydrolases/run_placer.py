...
df = pd.read_pickle('/nvme2/helen/EnzymeStructuralFiltering/benchmarking/metallohydrolases/filterzyme_output/geometricfiltering/structural_features_final.pkl')
# os.chdir('test_placer/metallohydrolases/')
