...
class Docking:
    def __init__(
        ...
        alternative_strucuture_for_vina = 'Chai',
        num_threads = 1
    ):
        self.df = df.copy()
    ...
    def _run_vina(self, df_boltz, alternative_strucuture_for_vina):
        ...
        if self.metagenomic_enzymes == 1:
            if alternative_strucuture_for_vina == 'Chai':
            ...
            elif alternative_strucuture_for_vina == 'Boltz':
...
class Pipeline:
    ...
    def run(self):
        ...
        docking = Docking(
            ...
            alternative_strucuture_for_vina = self.alternative_structure_for_vina, 
